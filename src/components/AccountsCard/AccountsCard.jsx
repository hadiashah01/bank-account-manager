  ...
  return (
    <div className="accounts-card">
      ...
      <ul className="account-card-wrapper">
        <li
          className={`card ${activeAccount == accounts[0] ? " active" : ""}`}
        ...
        <li
          className={`card ${activeAccount == accounts[1] ? "active" : ""}`}
        ...
        >
          <div className="card-header">
            <svg
              ...
              fill="#005BCB"
            >
              <path d="M668.5-531.5Q680-543 680-560t-11.5-28.5Q657-600 640-600t-28.5 11.5Q600-577 600-560t11.5 28.5Q623-520 640-520t28.5-11.5ZM320-600h200v-80H320v80ZM180-120q-34-114-67-227.5T80-580q0-92 64-156t156-64h200q29-38 70.5-59t89.5-21q25 0 42.8 17.5T720-820q0 6-1.5 12t-3.5 11q-4 11-7.5 22.8T702-751l91 91h87v279l-113 37-67 224H480v-80h-80v80H180Zm60-80h80v-80h240v80h80l62-206 98-33v-141h-40L620-720q0-20 2.8-38.5T630-796q-29 8-51 27.5T547-720H300q-58 0-99 41t-41 99q0 98 27 191.5T240-200Zm240-298Z" />
            </svg>
            <div>
        ...
        <li
          className={`card ${activeAccount == accounts[2] ? "active" : ""}`}
