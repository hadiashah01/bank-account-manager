      ...
      <ul className="account-card-wrapper">
        <li className="checking-card active">
          <div className="card-header">
            ...
            <div>
              <span className="account-type">{accounts[0].type}</span>
              <h3 className="account-holder">{accounts[0].holder}</h3>
            </div>
          </div>
          <div className="card-body">
            <span className="card-number">****{accounts[0].id}</span>
        ...
        <li className="saving-card">
          <div className="card-header">
            ...
            <div>
              <span className="account-type">{accounts[1].type}</span>
              <h3 className="account-holder">{accounts[1].holder}</h3>
            </div>
          </div>
          <div className="card-body">
            <span className="card-number">****{accounts[1].id}</span>
        ...
        <li className="credit-card">
          <div className="card-header">
            ...
            <div>
              <span className="account-type">{accounts[2].type}</span>
              <h3 className="account-holder">{accounts[2].name}</h3>
            </div>
          </div>
          <div className="card-body">
            <span className="card-number">****{accounts[2].balance}</span>
